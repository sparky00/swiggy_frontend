        ...
        <div className="header">
            ...
            <div className="nav-items">
                <ul>
                    ...
                    <li>
                        <Link className="nav-item" style={{fontWeight:"600"}} to="/cart">
                        Cart ({cartItems.length} items)
                        </Link>
                        </li>
                    <li className="nav-item" style={{fontWeight:"600", color:"green"}}>{user?.user?.data?.userName}</li>
                    <li className="nav-item" style={{fontWeight:"600", color:"green"}}>
